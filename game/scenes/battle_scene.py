...
class BattleScene(Scene):
    def __init__(self, game, mode_name="Padrao", **kwargs):
        ...
        self.end_turn_btn = Button((1035, 695, 210, 52), "Encerrar turno", self.end_turn)
        ...
        # Agora as cartas ficam viradas uma para a outra
        ...
        self.right_panel_rect = pygame.Rect(1030, 120, 220, 560)

        # Barra inferior aumentada para mostrar a carta inteira
        self.hand_panel_rect = pygame.Rect(70, 545, 930, 250)
        self.hand_view_rect = pygame.Rect(115, 590, 820, 190)
        self.hand_start_x = self.hand_view_rect.x
        self.hand_y = self.hand_view_rect.y
        self.hand_scroll_x = 0
        self.hand_min_gap = 18

        self.left_arrow_rect = pygame.Rect(80, 655, 28, 50)
        self.right_arrow_rect = pygame.Rect(945, 655, 28, 50)
